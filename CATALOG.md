...
| **[conservation-enforcer](https://github.com/SuperInstance/conservation-enforcer)** | Forgemaster | ⚡ FLUX bytecode conservation-law enforcement for LLM outputs — deterministic AI governance via bytec | 🟢 active |
| **[conservation-enforcer-rs](https://github.com/SuperInstance/conservation-enforcer-rs)** | Forgemaster | Rust implementation of FLUX bytecode conservation-law enforcement for LLM outputs | 🟢 active |
...
| **[eisenstein-cuda](https://github.com/SuperInstance/eisenstein-cuda)** | Forgemaster | Eisenstein integer constraint math for CUDA/C — norm, multiply, conjugate, disk check, XOR dual-path | 🟢 active |
...
| **[eisenstein-quantize](https://github.com/SuperInstance/eisenstein-quantize)** | Forgemaster | Hexagonal A₂ lattice — natural grid for balanced ternary | 🟢 active |
...
| **[flux-certify](https://github.com/SuperInstance/flux-certify)** | Forgemaster | FLUX-C guard constraint compiler — generates proof certificates for safety-critical systems with byt | 🟢 active |
...
| **[flux-compiler-rs](https://github.com/SuperInstance/flux-compiler-rs)** | Forgemaster | FLUX bytecode assembler, disassembler, and validator (Rust) | 🟢 active |
...
| **[flux-core](https://github.com/SuperInstance/flux-core)** | Forgemaster | FLUX bytecode runtime — Fluid Language Universal eXecution: a zero-dependency register-based VM. Pub | 🟢 active |
...
| **[flux-policy-tester](https://github.com/SuperInstance/flux-policy-tester)** | Forgemaster | 🧪 Testing framework for FLUX bytecode agent policies — verify behavior, fuzz edge cases, enforce con | 🟢 active |
| **[flux-policy-tester-rs](https://github.com/SuperInstance/flux-policy-tester-rs)** | Forgemaster | Rust framework for testing FLUX agent policies with fuzzing and conservation bounds | 🟢 active |
...
| **[flux-registry](https://github.com/SuperInstance/flux-registry)** | Forgemaster | npm for agent policies — pre-compiled FLUX bytecode, installable and runnable | 🟢 active |
| **[flux-registry-rs](https://github.com/SuperInstance/flux-registry-rs)** | Forgemaster | Rust CLI for installing and running pre-compiled FLUX agent policies | 🟢 active |
...
| **[sat-solver](https://github.com/SuperInstance/sat-solver)** | Forgemaster | SAT solver for constraint satisfaction in SuperInstance agents | 🟢 active |
...
| **[si-gradient-flow](https://github.com/SuperInstance/si-gradient-flow)** | Forgemaster | Proof of concept: gradient flows on agent state spaces with conservation constraints — 4 optimizatio | 🟢 active |
...
| **[si-variational-agent](https://github.com/SuperInstance/si-variational-agent)** | Forgemaster | Proof of concept: variational principle for optimal agent budget allocation — Euler-Lagrange with co | 🟢 active |
...
| **[fleet-a2a-spectral](https://github.com/SuperInstance/fleet-a2a-spectral)** | Oracle1 | Graph spectral topology to music — Laplacian eigenvalues, Fiedler vectors, and Cheeger constants bec | 🟢 active |
...
| **[fleet-health](https://github.com/SuperInstance/fleet-health)** | Forgemaster | Health monitoring for the SuperInstance fleet — tracks agent node status and system vitality | 🟢 active |
...
| **[fleet-intel](https://github.com/SuperInstance/fleet-intel)** | Forgemaster | fleet-intel | 🟢 active |
...
| **[fleet-midi-arp](https://github.com/SuperInstance/fleet-midi-arp)** | Forgemaster | Ternary arpeggiation engine — one of 16 MIDI agents mapping {-1,0,+1} operations to cascading arpegg | 🟢 active |
...
| **[fleet-midi-bass](https://github.com/SuperInstance/fleet-midi-bass)** | Forgemaster | Ternary bass line generator — one of 16 MIDI agents mapping {-1,0,+1} operations to harmonic and rhy | 🟢 active |
...
| **[fleet-midi-groove](https://github.com/SuperInstance/fleet-midi-groove)** | Forgemaster | Ternary swing and groove engine — one of 16 MIDI agents shaping timing feel via {-1,0,+1} operations | 🟢 active |
...
| **[fleet-midi-melody](https://github.com/SuperInstance/fleet-midi-melody)** | Forgemaster | Ternary melodic contour generator — one of 16 MIDI agents shaping tune contours via {-1,0,+1} operat | 🟢 active |
...
| **[fleet-neofetch](https://github.com/SuperInstance/fleet-neofetch)** | Forgemaster | Fleet system info at a glance — neofetch for agent fleets | 🟢 active |
...
| **[lau-git-render](https://github.com/SuperInstance/lau-git-render)** | Oracle1 | Multi-format rendering layer — one render call outputs to terminal, dashboard, game engine, Telegram | 🟢 active |
| **[lau-leverage-singularity](https://github.com/SuperInstance/lau-leverage-singularity)** | Forgemaster | Singularity topology — the center does zero work, has infinite torque, total dependency is the sourc | 🟢 active |
| **[lau-murmur-protocol-v2](https://github.com/SuperInstance/lau-murmur-protocol-v2)** | Oracle1 | Gossip-based information spreading with epidemic models — SIR model, anti-entropy, rumor tracking in | 🟢 active |
...
| **[si-morse-theory](https://github.com/SuperInstance/si-morse-theory)** | Forgemaster | Proof of concept: Morse theory for agent state landscapes — critical points determine fleet topology | 🟢 active |
...
| **[forge-pi](https://github.com/SuperInstance/forge-pi)** | JetsonClaw1 | Edge agent runtime and central nervous system of the SuperInstance fleet — dispatch, discovery, comp | 🟢 active |
...
| **[lau-bytecode](https://github.com/SuperInstance/lau-bytecode)** | JetsonClaw1 | Stack-based bytecode VM for agent programs — 28 opcodes, compiler, sensor/actuator I/O, emotional vi | 🟢 active |
...
| **[lau-conservation-engine](https://github.com/SuperInstance/lau-conservation-engine)** | JetsonClaw1 | Runtime conservation-law verifier — double-entry energy ledger for agents with budget tracking and t | 🟢 active |
| **[lau-derived-topos](https://github.com/SuperInstance/lau-derived-topos)** | JetsonClaw1 | Elementary topos theory and derived functors — computational framework modeling agent knowledge as a | 🟢 active |
...
| **[lau-inheritance](https://github.com/SuperInstance/lau-inheritance)** | JetsonClaw1 | Models intergenerational transfer of artifacts and knowledge in the PLATO ecosystem with maker linea | 🟢 active |
...
| **[lau-math-opencl](https://github.com/SuperInstance/lau-math-opencl)** | JetsonClaw1 | Hardware-agnostic GPU math layer using OpenCL 1.2 — matrix ops, Laplacian, spectral analysis, batche | 🟢 active |
...
| **[notebooklm-bridge](https://github.com/SuperInstance/notebooklm-bridge)** | JetsonClaw1 | Bridge to Google NotebookLM for SuperInstance knowledge integration | 🟢 active |
...
| **[plato-hardware-engine](https://github.com/SuperInstance/plato-hardware-engine)** | JetsonClaw1 | plato-hardware-engine | 🟢 active |
...
| **[dream-compiler](https://github.com/SuperInstance/dream-compiler)** | Various | Compiler infrastructure — part of the SuperInstance fleet ecosystem for distributed cognitive agent  | 🟢 active |
| **[dream-cycle](https://github.com/SuperInstance/dream-cycle)** | Various | Rust exocortex crate: dream-cycle | ⚪ unknown |
| **[dual-connection](https://github.com/SuperInstance/dual-connection)** | Various | Dual affine connections on statistical manifolds — e/m duality, curvature, parallel transport, and i | ⚪ unknown |
...
| **[ecosystem-graph](https://github.com/SuperInstance/ecosystem-graph)** | Various | SuperInstance crate dependency analyzer — maps ecosystem interconnections, finds orphans, identifies | ⚪ unknown |
| **[ecosystem-thesis](https://github.com/SuperInstance/ecosystem-thesis)** | Various | The Snap-On Ecosystem thesis essay | ⚪ unknown |
...
| **[emergence-detector](https://github.com/SuperInstance/emergence-detector)** | Various | emergence-detector | ⚪ unknown |
...
| **[entropy-code](https://github.com/SuperInstance/entropy-code)** | Various | Entropy coding fundamentals in pure Rust — Shannon entropy, optimal code lengths, Kraft inequality,  | ⚪ unknown |
| **[entropy-conservation-rs](https://github.com/SuperInstance/entropy-conservation-rs)** | Various | Entropy conservation tracking with Hodge decomposition — gradient, curl, and harmonic components for | ⚪ unknown |
...
| **[ergodic-transport-c](https://github.com/SuperInstance/ergodic-transport-c)** | Various | Birkhoff's ergodic theorem as a C library — capacity planning and time-series forecasting with mathe | ⚪ unknown |
| **[ergodic-transport-rs](https://github.com/SuperInstance/ergodic-transport-rs)** | Various | Ergodic transport theory in Rust — capacity planning and forecasting for the SuperInstance fleet | ⚪ unknown |
...
| **[fft-rs](https://github.com/SuperInstance/fft-rs)** | Various | Fast Fourier Transform in pure Rust — Cooley-Tukey radix-2, iterative FFT, IFFT, convolution, and DC | ⚪ unknown |
...
| **[fisher-rao](https://github.com/SuperInstance/fisher-rao)** | Various | Fisher-Rao metric, Cramér-Rao bound, information matrix, and Rao distance for parametric statistical | ⚪ unknown |
...
| **[forge-transform](https://github.com/SuperInstance/forge-transform)** | Various | Tile transform library for Plato agents — composable, trackable, serializable transforms with conser | 🟢 active |
...
| **[fork-strategy-doc](https://github.com/SuperInstance/fork-strategy-doc)** | Various | Architectural analysis of the SuperInstance fork enhancement strategy | ⚪ unknown |
| **[fractal-gen-rs](https://github.com/SuperInstance/fractal-gen-rs)** | Various | Fractal generation: Mandelbrot, Julia, Burning Ship, Sierpinski, Koch snowflake in pure Rust | ⚪ unknown |
| **[free-energy](https://github.com/SuperInstance/free-energy)** | Various | Free Energy Principle computational core — variational free energy, generative models, prediction er | ⚪ unknown |
...
| **[free-probability-c](https://github.com/SuperInstance/free-probability-c)** | Various | Free probability theory in C — R-transform, Marchenko-Pastur distribution, and random matrix analysi | ⚪ unknown |
| **[free-probability-rs](https://github.com/SuperInstance/free-probability-rs)** | Various | Free probability theory in Rust — R-transform, S-transform, and random matrix analysis for the Super | ⚪ unknown |
...
| **[fs-layout](https://github.com/SuperInstance/fs-layout)** | Various | Filesystem layout simulator — inodes, directory trees, block allocation bitmaps, and path resolution | ⚪ unknown |
...
| **[ga-core-rs](https://github.com/SuperInstance/ga-core-rs)** | Various | Geometric algebra Cl(3,1) spacetime algebra — multivectors, rotors, conformal embedding for spatial  | ⚪ unknown |
...
| **[gossip-sub](https://github.com/SuperInstance/gossip-sub)** | Various | Gossip-based message dissemination for distributed systems — membership, fan-out routing, anti-entro | ⚪ unknown |
...
| **[gpu-scaling](https://github.com/SuperInstance/gpu-scaling)** | Various | gpu-scaling | ⚪ unknown |
...
| **[graph-homology](https://github.com/SuperInstance/graph-homology)** | Various | Homological invariants of graphs — clique complexes, Betti numbers, Euler characteristic, and graph  | 🟢 active |
...
| **[hoare-logic](https://github.com/SuperInstance/hoare-logic)** | Various | Hoare logic in Rust — weakest precondition, strongest postcondition, verification condition generati | ⚪ unknown |
| **[hodge-belief](https://github.com/SuperInstance/hodge-belief)** | Various | Hodge decomposition for belief states — splits signals into exact, co-exact, and harmonic components | ⚪ unknown |
| **[hodge-belief-c](https://github.com/SuperInstance/hodge-belief-c)** | Various | C11 Hodge decomposition for belief networks — separates evidence, coherence, and prior components of | ⚪ unknown |
...
| **[horse-shell](https://github.com/SuperInstance/horse-shell)** | Various | horse-shell | ⚪ unknown |
| **[huffman-code](https://github.com/SuperInstance/huffman-code)** | Various | Huffman coding in pure Rust — frequency analysis, tree construction, canonical codes, and adaptive e | ⚪ unknown |
...
| **[landauer](https://github.com/SuperInstance/landauer)** | Various | Information thermodynamics — Landauer's principle computing the physical energy cost of erasing info | ⚪ unknown |
| **[lapce-coverage-gap](https://github.com/SuperInstance/lapce-coverage-gap)** | Various | Topological data analysis for test coverage gaps — finds blind spots in Rust test suites using persi | ⚪ unknown |
...
| **[lau-a2ui](https://github.com/SuperInstance/lau-a2ui)** | Various | Rendering-agnostic state for PLATO — one world state rendered as ASCII, MUD, HTML, Unity, Godot, Rob | ⚪ unknown |
| **[lau-a2ui-protocol](https://github.com/SuperInstance/lau-a2ui-protocol)** | Various | Binary wire protocol for multi-target UI state — bincode payloads, CRC32 checksums, typed packets fo | ⚪ unknown |
| **[lau-achievements](https://github.com/SuperInstance/lau-achievements)** | Various | Badge and achievement system for PLATO/LAU — 33 built-in badges across 7 categories and 5 tiers with | ⚪ unknown |
| **[lau-adinkra](https://github.com/SuperInstance/lau-adinkra)** | Various | Adinkra symbols as behavioral signatures for PLATO agents — maps 5D behavioral vectors to West Afric | 🟢 active |
| **[lau-agent-dream](https://github.com/SuperInstance/lau-agent-dream)** | Various | Dream cycle for idle agents — offline experience processing with consolidation, replay, and generati | 🟢 active |
| **[lau-agent-homeostasis](https://github.com/SuperInstance/lau-agent-homeostasis)** | Various | Self-regulating control for agents — PID, bang-bang, threshold regulators, circadian rhythms, stress | 🟢 active |
...
| **[lau-agent-profile](https://github.com/SuperInstance/lau-agent-profile)** | Various | Behavioral profiling for PLATO agents — tracks soul (personality) and armor (capabilities) for missi | 🟢 active |
| **[lau-agent-runtime](https://github.com/SuperInstance/lau-agent-runtime)** | Various | Self-compiling agent runtime — agents build their own mini-interpreters with bytecode, builtins, and | 🟢 active |
| **[lau-agent-shell](https://github.com/SuperInstance/lau-agent-shell)** | Various | PLATO agent shell — translates between agent internal state and game character appearance in a voxel | 🟢 active |
| **[lau-agent-thermodynamics](https://github.com/SuperInstance/lau-agent-thermodynamics)** | Various | Thermodynamics of computation — Landauer bound, Carnot learning, Maxwell's demon, fluctuation theore | 🟢 active |
| **[lau-agent-unify](https://github.com/SuperInstance/lau-agent-unify)** | Various | Unified type system for room ensigns and git-native agents in the PLATO/LAU ecosystem | 🟢 active |
...
| **[lau-algebraic-geometry](https://github.com/SuperInstance/lau-algebraic-geometry)** | Various | Computational algebraic geometry in Rust — polynomial rings, ideals, Gröbner bases, elimination theo | ⚪ unknown |
| **[lau-animation](https://github.com/SuperInstance/lau-animation)** | Various | Sprite and property animation system — keyframe interpolation, skeletal hints, procedural animation  | ⚪ unknown |
...
| **[lau-architecture](https://github.com/SuperInstance/lau-architecture)** | Various | Architecture documentation for the PLATO/LAU mathematical agent framework — part of the SuperInstanc | 🟢 active |
| **[lau-async-tick](https://github.com/SuperInstance/lau-async-tick)** | Various | Tick-based task engine with priority queues, handler dispatch, delegation, and escalation for game-a | 🟢 active |
...
| **[lau-banach-agents](https://github.com/SuperInstance/lau-banach-agents)** | Various | Banach space theory for agents — fixed-point theorem, Hahn-Banach, open mapping, Riesz representatio | 🟢 active |
...
| **[lau-blueprint](https://github.com/SuperInstance/lau-blueprint)** | Various | Voxel building-plan system — materials, structural validation, cost accounting, and blueprint librar | ⚪ unknown |
| **[lau-bridge](https://github.com/SuperInstance/lau-bridge)** | Various | Cross-pollination bridge connecting PLATO research ecosystem with the Lau game world | ⚪ unknown |
| **[lau-bridge-pattern-math](https://github.com/SuperInstance/lau-bridge-pattern-math)** | Various | Bridges Grand Pattern system with deep math — spectral theory, sheaves, category theory, optimal tra | ⚪ unknown |
| **[lau-bridge-tutor](https://github.com/SuperInstance/lau-bridge-tutor)** | Various | Tutoring bridge for the PLATO/LAU mathematical agent framework — educational agent support | 🟢 active |
| **[lau-bytecode-c](https://github.com/SuperInstance/lau-bytecode-c)** | Various | LAU bytecode VM - C port | ⚪ unknown |
| **[lau-calm-noether](https://github.com/SuperInstance/lau-calm-noether)** | Various | Proves CALM theorem equivalence — coordination-free learning equals permutation symmetry equals cons | ⚪ unknown |
| **[lau-camera](https://github.com/SuperInstance/lau-camera)** | Various | 2D camera system for games — viewport, zoom, follow, shake, and smooth transitions for PLATO game wo | ⚪ unknown |
| **[lau-categorical-homotopy](https://github.com/SuperInstance/lau-categorical-homotopy)** | Various | Homotopy type theory for agent systems — paths, homotopies, fundamental groupoids, higher inductive  | 🟢 active |
| **[lau-categorical-mechanics](https://github.com/SuperInstance/lau-categorical-mechanics)** | Various | Categorical foundations unifying symplectic mechanics and agent behaviors — Hamiltonian functors map | 🟢 active |
...
| **[lau-challenge](https://github.com/SuperInstance/lau-challenge)** | Various | Challenge and arena system for PLATO/LAU — kids create challenges and the system validates solutions | ⚪ unknown |
...
| **[lau-circuit](https://github.com/SuperInstance/lau-circuit)** | Various | Deadband circuit system — tick-based automations with tolerance bands, trend tracking, and escalatio | 🟢 active |
...
| **[lau-collab](https://github.com/SuperInstance/lau-collab)** | Various | Multiplayer collaboration layer — shared worlds, player matching, co-building, agent sharing, and se | 🟢 active |
| **[lau-collections](https://github.com/SuperInstance/lau-collections)** | Various | Custom data structures optimized for game workloads in the PLATO/LAU ecosystem | ⚪ unknown |
...
| **[lau-complex-agents](https://github.com/SuperInstance/lau-complex-agents)** | Various | Complex analysis for autonomous agents — contour integration, residue calculus, Julia/Mandelbrot dyn | 🟢 active |
...
| **[lau-compression](https://github.com/SuperInstance/lau-compression)** | Various | Nine classic compression algorithms plus entropy analysis and agent-data compressor — 62 tests, zero | 🟢 active |
...
| **[lau-conservation-laws](https://github.com/SuperInstance/lau-conservation-laws)** | Various | Conservation laws in discrete systems — Noether's theorem, finite-volume schemes, and CRDT conservat | 🟢 active |
| **[lau-conservation-matrix](https://github.com/SuperInstance/lau-conservation-matrix)** | Various | Doubly stochastic matrices — Birkhoff decomposition, Sinkhorn balancing, exchange graphs, and conser | ⚪ unknown |
| **[lau-conservation-spectral](https://github.com/SuperInstance/lau-conservation-spectral)** | Various | Conservation spectral framework — Laplacian eigenvalue analysis, spectral fingerprints, and agent co | 🟢 active |
| **[lau-constellation](https://github.com/SuperInstance/lau-constellation)** | Various | Constellation mapping for the PLATO/LAU agent ecosystem — visualizes agent relationships and capabil | 🟢 active |
...
| **[lau-construct](https://github.com/SuperInstance/lau-construct)** | Various | The Matrix Construct — shared creative space where user and agent co-create PLATO environments via n | 🟢 active |
...
| **[lau-construct-integration](https://github.com/SuperInstance/lau-construct-integration)** | Various | Integration tests proving lau-* crates compose correctly across the PLATO/LAU ecosystem | ⚪ unknown |
...
| **[lau-cudaclaw-bridge](https://github.com/SuperInstance/lau-cudaclaw-bridge)** | Various | Bridge connecting the lau-* math library ecosystem (77+ crates) to CUDAclaw GPU dispatch system | ⚪ unknown |
...
| **[lau-dialogue](https://github.com/SuperInstance/lau-dialogue)** | Various | Dialogue system for PLATO/LAU agents — conversational interfaces for educational interactions | 🟢 active |
| **[lau-diffusion-agents](https://github.com/SuperInstance/lau-diffusion-agents)** | Various | Diffusion processes for agents — Brownian motion, Itô calculus, Fokker-Planck, Langevin, optimal tra | 🟢 active |
...
| **[lau-distribution-agents](https://github.com/SuperInstance/lau-distribution-agents)** | Various | Schwartz distribution theory for agents — analyze rough, discontinuous policies via test functions a | 🟢 active |
| **[lau-docs-dream-compiler-spec](https://github.com/SuperInstance/lau-docs-dream-compiler-spec)** | Various | Specification for the LAU dream compiler — part of the SuperInstance fleet ecosystem | ⚪ unknown |
| **[lau-docs-quest-design](https://github.com/SuperInstance/lau-docs-quest-design)** | Various | Quest design documentation for the PLATO/LAU educational agent ecosystem | 🟢 active |
| **[lau-docs-voice-patterns](https://github.com/SuperInstance/lau-docs-voice-patterns)** | Various | Voice interaction patterns documentation for the SuperInstance fleet ecosystem | ⚪ unknown |
| **[lau-domestication](https://github.com/SuperInstance/lau-domestication)** | Various | Models domestication dynamics between agents — love, contract, play, force, optimization relationshi | 🟢 active |
...
| **[lau-ecosystem](https://github.com/SuperInstance/lau-ecosystem)** | Various | Top-level ecosystem coordination for the SuperInstance fleet of distributed cognitive agents | 🟢 active |
| **[lau-ecosystem-unified](https://github.com/SuperInstance/lau-ecosystem-unified)** | Various | Central coordination crate bridging 320+ lau-* crates via spectral triples and ecosystem health moni | ⚪ unknown |
| **[lau-ecs](https://github.com/SuperInstance/lau-ecs)** | Various | Bitmask-driven Entity Component System for simulation-style game worlds in Rust with 13 component ty | ⚪ unknown |
...
| **[lau-ensign](https://github.com/SuperInstance/lau-ensign)** | Various | Small-model ensign system that orients from room state and keeps readiness at yellow alert | ⚪ unknown |
| **[lau-ensign-sdk](https://github.com/SuperInstance/lau-ensign-sdk)** | Various | SDK for defining, configuring, and deploying ensign sub-agents with preset profiles and fluent build | 🟢 active |
| **[lau-ergodic-gradient](https://github.com/SuperInstance/lau-ergodic-gradient)** | Various | Gradient descent as time-reversed ergodic diffusion — Bakry-Émery curvature, log-Sobolev, Wasserstei | ⚪ unknown |
...
| **[lau-error-correcting-codes](https://github.com/SuperInstance/lau-error-correcting-codes)** | Various | Error-correcting codes: Hamming, Reed-Solomon, convolutional with Viterbi, CRC, and Shannon's theore | ⚪ unknown |
| **[lau-event-bus](https://github.com/SuperInstance/lau-event-bus)** | Various | Pub/sub event bus — the nervous system connecting all PLATO crates | ⚪ unknown |
| **[lau-evolution](https://github.com/SuperInstance/lau-evolution)** | Various | World evolution engine — rooms mutate under selection pressure, species emerge via clustering, extin | ⚪ unknown |
...
| **[lau-feedback](https://github.com/SuperInstance/lau-feedback)** | Various | Feedback loops and signal processing for the SuperInstance fleet ecosystem | ⚪ unknown |
| **[lau-ffi-bindings](https://github.com/SuperInstance/lau-ffi-bindings)** | Various | Cross-language FFI infrastructure — safe C string handling, C-compatible vectors, opaque handles, WA | ⚪ unknown |
...
| **[lau-fixedpoint](https://github.com/SuperInstance/lau-fixedpoint)** | Various | Q16.16 fixed-point arithmetic library for deterministic cross-platform computation with no FPU requi | ⚪ unknown |
...
| **[lau-fuzzy-logic](https://github.com/SuperInstance/lau-fuzzy-logic)** | Various | Fuzzy logic and fuzzy systems — membership functions, Mamdani/Sugeno inference, defuzzification, age | 🟢 active |
| **[lau-galois-agents](https://github.com/SuperInstance/lau-galois-agents)** | Various | Galois theory applied to agent capability spaces — constructibility, symmetries, and insolvability p | 🟢 active |
...
| **[lau-gateway-demo](https://github.com/SuperInstance/lau-gateway-demo)** | Various | Gateway demo for the SuperInstance fleet ecosystem — distributed cognitive agent orchestration | 🟢 active |
...
| **[lau-geometric-deep-learning](https://github.com/SuperInstance/lau-geometric-deep-learning)** | Various | Geometric deep learning — permutation, rotation, scale, time, and gauge equivariance for agent syste | 🟢 active |
...
| **[lau-grand-unification](https://github.com/SuperInstance/lau-grand-unification)** | Various | Capstone crate — all 14 executable theorems project from one spectral triple (A, H, D) unifying the  | ⚪ unknown |
| **[lau-graph-theory](https://github.com/SuperInstance/lau-graph-theory)** | Various | Graph theory toolkit — traversals, shortest paths, MST, network flow, matching, spectral analysis, a | 🟢 active |
| **[lau-gravity-field](https://github.com/SuperInstance/lau-gravity-field)** | Various | Continuous gravity tensor field that evolves via diffusion — spatial attention, energy, and novelty  | ⚪ unknown |
...
| **[lau-hermes-oracle-boot](https://github.com/SuperInstance/lau-hermes-oracle-boot)** | Various | Boot sequence simulator for hermes-construct on Oracle ARM — phased startup with structured logging | ⚪ unknown |
...
| **[lau-homotopy-type](https://github.com/SuperInstance/lau-homotopy-type)** | Various | Homotopy Type Theory — cubical types, path types, univalence, HITs, fundamental groups, compiler ver | ⚪ unknown |
| **[lau-index-theorem](https://github.com/SuperInstance/lau-index-theorem)** | Various | lau-index-theorem | ⚪ unknown |
| **[lau-information-geometry](https://github.com/SuperInstance/lau-information-geometry)** | Various | Information geometry — Fisher metric, geodesics, natural gradient descent, KL divergence on statisti | ⚪ unknown |
...
| **[lau-information-theory](https://github.com/SuperInstance/lau-information-theory)** | Various | Shannon information theory — entropy, mutual information, channel capacity, Huffman coding, Blahut-A | ⚪ unknown |
| **[lau-input](https://github.com/SuperInstance/lau-input)** | Various | Input handling and signal ingestion for the SuperInstance fleet ecosystem | ⚪ unknown |
| **[lau-integration-test](https://github.com/SuperInstance/lau-integration-test)** | Various | Integration tests for the SuperInstance fleet ecosystem of distributed cognitive agents | 🟢 active |
...
| **[lau-intention-field](https://github.com/SuperInstance/lau-intention-field)** | Various | Vector field over agent space — sources radiate intention, agents follow gradients, field evolves th | 🟢 active |
| **[lau-inter-shell](https://github.com/SuperInstance/lau-inter-shell)** | Various | Inter-shell communication bus with trust-gated messaging, briefings, and route enforcement between a | 🟢 active |
| **[lau-jepa-gravity](https://github.com/SuperInstance/lau-jepa-gravity)** | Various | Room-based gravity system — single f64 per room deterministically derives model parameters like Mand | ⚪ unknown |
| **[lau-kahler-agents](https://github.com/SuperInstance/lau-kahler-agents)** | Various | Kähler geometry for agents — complex structures, symplectic forms, Ricci curvature, Calabi-Yau, Hodg | 🟢 active |
...
| **[lau-kalman-hodge](https://github.com/SuperInstance/lau-kalman-hodge)** | Various | Kalman filter reinterpreted as Hodge star operator on observation bundles — spectral bridge for stat | ⚪ unknown |
...
| **[lau-kintsugi-runtime](https://github.com/SuperInstance/lau-kintsugi-runtime)** | Various | Kintsugi principle for agents — failures make artifacts more valuable through tracked break-repair g | 🟢 active |
| **[lau-koopman-agents](https://github.com/SuperInstance/lau-koopman-agents)** | Various | lau-koopman-agents | 🟢 active |
| **[lau-landauer-meter](https://github.com/SuperInstance/lau-landauer-meter)** | Various | Thermodynamic cost meter — Landauer principle, Fisher-Rao distance, and compute efficiency of agent  | 🟢 active |
...
| **[lau-logic-foundations](https://github.com/SuperInstance/lau-logic-foundations)** | Various | Mathematical logic — propositional, predicate, DPLL SAT solver, natural deduction, Gödel numbering,  | 🟢 active |
...
| **[lau-math-go](https://github.com/SuperInstance/lau-math-go)** | Various | Go services layer for LAU math — REST APIs, gRPC, fleet orchestration, agent lifecycle, CRDT-based f | 🟢 active |
| **[lau-matrix-analysis](https://github.com/SuperInstance/lau-matrix-analysis)** | Various | Matrix analysis — LU, QR, Cholesky, SVD, eigendecompositions, norms, perturbation theory, Kronecker  | ⚪ unknown |
| **[lau-mean-field-agents](https://github.com/SuperInstance/lau-mean-field-agents)** | Various | Mean-field games for agent populations — Lasry-Lions coupled HJB/Fokker-Planck fixed point and Nash  | 🟢 active |
| **[lau-measure-agents](https://github.com/SuperInstance/lau-measure-agents)** | Various | Measure theory for agents — σ-algebras, Lebesgue integral, Radon-Nikodym, product measures, belief s | 🟢 active |
...
| **[lau-memory-tiles](https://github.com/SuperInstance/lau-memory-tiles)** | Various | Memory tiles for AI agents — typed, timestamped, importance-weighted records with decay, reinforceme | 🟢 active |
...
| **[lau-mission](https://github.com/SuperInstance/lau-mission)** | Various | Mission lifecycle library — planning, briefing, execution, completion, failure, and post-mortem anal | 🟢 active |
...
| **[lau-narrator](https://github.com/SuperInstance/lau-narrator)** | Various | Narrative generation and storytelling for the SuperInstance fleet ecosystem | ⚪ unknown |
...
| **[lau-network](https://github.com/SuperInstance/lau-network)** | Various | Networking layer for the SuperInstance fleet ecosystem of distributed cognitive agents | 🟢 active |
...
| **[lau-noise](https://github.com/SuperInstance/lau-noise)** | Various | Noise generation and signal perturbation for the SuperInstance fleet ecosystem | ⚪ unknown |
...
| **[lau-number-theory](https://github.com/SuperInstance/lau-number-theory)** | Various | Number theory — primes, modular arithmetic, continued fractions, Pell's equation, Dirichlet L-functi | 🟢 active |
| **[lau-numerical-agents](https://github.com/SuperInstance/lau-numerical-agents)** | Various | Numerical methods — matrix decompositions, ODE/PDE solvers, optimization, quadrature, interpolation  | 🟢 active |
...
| **[lau-observation-control](https://github.com/SuperInstance/lau-observation-control)** | Various | Observation-control adjunction — Kalman filter as unit, LQR as counit, category-theoretic agent loop | 🟢 active |
| **[lau-onboarding](https://github.com/SuperInstance/lau-onboarding)** | Various | 6-phase ensign orientation — identity, room config, briefing, story building, first assignment, and  | ⚪ unknown |
...
| **[lau-optimal-control](https://github.com/SuperInstance/lau-optimal-control)** | Various | Optimal control — LQR, Riccati equations, Pontryagin's Maximum Principle, HJB, bang-bang, trajectory | ⚪ unknown |
| **[lau-optimal-transport-agents](https://github.com/SuperInstance/lau-optimal-transport-agents)** | Various | Optimal transport for agents — Sinkhorn algorithm, Wasserstein distances, barycenters for distributi | 🟢 active |
| **[lau-palaver](https://github.com/SuperInstance/lau-palaver)** | Various | Consensus protocol inspired by West African palaver tree — decisions through extended discussion unt | ⚪ unknown |
| **[lau-pde-agents](https://github.com/SuperInstance/lau-pde-agents)** | Various | lau-pde-agents | 🟢 active |
| **[lau-penrose](https://github.com/SuperInstance/lau-penrose)** | Various | lau-penrose | ⚪ unknown |
...
| **[lau-plato-tutor](https://github.com/SuperInstance/lau-plato-tutor)** | Various | The PLATO tutoring language — meaning-matched response evaluation using single embedding space for s | ⚪ unknown |
...
| **[lau-replay](https://github.com/SuperInstance/lau-replay)** | Various | lau-replay | ⚪ unknown |
...
| **[lau-room-native](https://github.com/SuperInstance/lau-room-native)** | Various | Room-native agent system where the room itself IS the agent's context — Rust implementation of spati | 🟢 active |
...
| **[lau-shell-transport](https://github.com/SuperInstance/lau-shell-transport)** | Various | Transport layer for inter-shell communication — unified Transport trait with memory, stdio, and file | ⚪ unknown |
...
| **[loom-weaver](https://github.com/SuperInstance/loom-weaver)** | Various | loom-weaver | ⚪ unknown |
...
| **[neural-crest](https://github.com/SuperInstance/neural-crest)** | Various | Neural crest cell differentiation simulator for developmental biology | ⚪ unknown |
...
| **[noise-gen-rs](https://github.com/SuperInstance/noise-gen-rs)** | Various | Noise generation: Perlin, Simplex, Worley/Voronoi, fractal Brownian motion in pure Rust | ⚪ unknown |
| **[normal-form](https://github.com/SuperInstance/normal-form)** | Various | Database normal form analysis and transformation tools | ⚪ unknown |
...
| **[ode-solver](https://github.com/SuperInstance/ode-solver)** | Various | Ordinary differential equation solver for SuperInstance physics | ⚪ unknown |
...
| **[openconstruct-kernel](https://github.com/SuperInstance/openconstruct-kernel)** | Various | Core kernel for the OpenConstruct modular agent framework | 🟢 active |
| **[openconstruct-modular](https://github.com/SuperInstance/openconstruct-modular)** | Various | Modular construction framework for SuperInstance agent architecture | 🟢 active |
...
| **[persistent-agent](https://github.com/SuperInstance/persistent-agent)** | Various | Persistent state management for long-running SuperInstance agents | 🟢 active |
...
| **[plato-audio-jepa](https://github.com/SuperInstance/plato-audio-jepa)** | Various | PLATO audio module using Joint-Embedding Predictive Architecture | ⚪ unknown |
...
| **[plato-core-rs](https://github.com/SuperInstance/plato-core-rs)** | Various | Rust implementation of the PLATO wire protocol — room runtime for agent interaction | 🟢 active |
...
| **[plato-engine-block-zig](https://github.com/SuperInstance/plato-engine-block-zig)** | Various | PLATO engine core block implemented in Zig for high-performance agent orchestration | 🟢 active |
...
| **[plato-hdc-bridge](https://github.com/SuperInstance/plato-hdc-bridge)** | Various | Hyperdimensional computing bridge for the PLATO engine | ⚪ unknown |
...
| **[plato-llvm-bridge](https://github.com/SuperInstance/plato-llvm-bridge)** | Various | LLVM IR bridge for the PLATO engine | ⚪ unknown |
...
| **[plato-mythos-bridge](https://github.com/SuperInstance/plato-mythos-bridge)** | Various | Bridge between PLATO engine and Mythos narrative system | ⚪ unknown |
...
| **[plato-portal](https://github.com/SuperInstance/plato-portal)** | Various | Python SDK for persistent multi-agent systems — agents with markdown memory, in-memory fleet, thread | 🟢 active |
...
| **[plato-room-security-audit](https://github.com/SuperInstance/plato-room-security-audit)** | Various | PLATO Security Audit Room — automated security auditing as an engine block | ⚪ unknown |
| **[plato-room-security-audit-rs](https://github.com/SuperInstance/plato-room-security-audit-rs)** | Various | PLATO Security Audit Room — Rust port of the Python security audit room. Heuristic vulnerability sca | ⚪ unknown |
...
| **[plato-semantic-search](https://github.com/SuperInstance/plato-semantic-search)** | Various | Production Cloudflare Worker for semantic search over the Plato/SuperInstance crate ecosystem using  | ⚪ unknown |
...
| **[plato-spectral](https://github.com/SuperInstance/plato-spectral)** | Various | PLATO spectral analysis module for signal processing | ⚪ unknown |
...
| **[plato-vision-jepa](https://github.com/SuperInstance/plato-vision-jepa)** | Various | PLATO vision module using Joint-Embedding Predictive Architecture | ⚪ unknown |
| **[plato-visual-mesh-mcp](https://github.com/SuperInstance/plato-visual-mesh-mcp)** | Various | MCP tools for visual memory mesh queries | ⚪ unknown |
| **[plato-voice](https://github.com/SuperInstance/plato-voice)** | Various | PLATO voice interface component for SuperInstance agents | 🟢 active |
| **[plato-watch](https://github.com/SuperInstance/plato-watch)** | Various | PLATO engine monitoring and observability dashboard | ⚪ unknown |
...
| **[plugin-runtime](https://github.com/SuperInstance/plugin-runtime)** | Various | Plugin runtime for OpenShell — sandboxed execution and lifecycle | ⚪ unknown |
...
| **[port-generator](https://github.com/SuperInstance/port-generator)** | Various | Port number generator and allocator for SuperInstance services | ⚪ unknown |
...
| **[raster-line](https://github.com/SuperInstance/raster-line)** | Various | Raster line drawing algorithms for SuperInstance graphics | ⚪ unknown |
...
| **[rate-limiter-rs](https://github.com/SuperInstance/rate-limiter-rs)** | Various | Rate limiting algorithms in Rust: token bucket, sliding window, fixed window, leaky bucket | ⚪ unknown |
...
| **[renormalization](https://github.com/SuperInstance/renormalization)** | Various | Renormalization group theory library for SuperInstance | ⚪ unknown |
...
| **[ring-sign](https://github.com/SuperInstance/ring-sign)** | Various | Ring signature cryptography for SuperInstance privacy systems | ⚪ unknown |
...
| **[sheaf-agents-c](https://github.com/SuperInstance/sheaf-agents-c)** | Various | Sheaf-theoretic agent framework in C | 🟢 active |
...
| **[sheaf-laplacian](https://github.com/SuperInstance/sheaf-laplacian)** | Various | Sheaf Laplacian computation for topological data analysis | ⚪ unknown |
...
| **[shell](https://github.com/SuperInstance/shell)** | Various | shell | ⚪ unknown |
| **[shepherds-console](https://github.com/SuperInstance/shepherds-console)** | Various | Single-pane operations for working animal infrastructure | ⚪ unknown |
...
| **[si-information-geodesic](https://github.com/SuperInstance/si-information-geodesic)** | Various | Proof of concept: Fisher information metric on agent state space — geodesics trace optimal budget tr | 🟢 active |
...
| **[si-markov-fleet](https://github.com/SuperInstance/si-markov-fleet)** | Various | Proof of concept: Markov chain analysis for fleet state transitions — stationary distributions, mixi | ⚪ unknown |
...
| **[si-topological-protect](https://github.com/SuperInstance/si-topological-protect)** | Various | Proof of concept: topological protection of agent consensus — homology classes determine structurall | 🟢 active |
...
| **[smt-core](https://github.com/SuperInstance/smt-core)** | Various | SMT (Satisfiability Modulo Theories) solver core for SuperInstance | ⚪ unknown |
...
| **[spectral-deadband-v2](https://github.com/SuperInstance/spectral-deadband-v2)** | Various | Spectral deadband filtering for signal processing in SuperInstance agents | 🟢 active |
...
| **[spectral-est](https://github.com/SuperInstance/spectral-est)** | Various | Spectral estimation library for SuperInstance signal processing | ⚪ unknown |
...
| **[spectral-graph-agent-rs](https://github.com/SuperInstance/spectral-graph-agent-rs)** | Various | Spectral graph analysis for agent reasoning, in Rust | 🟢 active |
...
| **[thermal-budget](https://github.com/SuperInstance/thermal-budget)** | Various | Thermal budget management for SuperInstance compute infrastructure | ⚪ unknown |
...
| **[training-throttle](https://github.com/SuperInstance/training-throttle)** | Various | Training rate throttling and backpressure for ML pipelines | ⚪ unknown |
| **[transfer-entropy](https://github.com/SuperInstance/transfer-entropy)** | Various | transfer-entropy | ⚪ unknown |
| **[trawl](https://github.com/SuperInstance/trawl)** | Various | Commercial fishing on Working Animal Architecture — routes are pastures, quotas are fences, vessels  | 🟢 active |
...
| **[tropical-graph](https://github.com/SuperInstance/tropical-graph)** | Various | Tropical algebra graph algorithms for SuperInstance | ⚪ unknown |
...
| **[vibe-graph](https://github.com/SuperInstance/vibe-graph)** | Various | Vibe-graph social network analysis for SuperInstance agents | 🟢 active |
...
| **[whistle](https://github.com/SuperInstance/whistle)** | Various | Intent DSL for Working Animal Architecture — replaces system-prompt sprawl with structured, compiled | ⚪ unknown |
| **[wiki](https://github.com/SuperInstance/wiki)** | Various | ⚠️ DEPRECATED — see https://github.com/SuperInstance/repo-docs | ⚪ unknown |
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** ⚡ FLUX bytecode conservation-law enforcement for LLM outputs — deterministic AI governance via bytecode policy layers
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Rust implementation of FLUX bytecode conservation-law enforcement for LLM outputs
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Eisenstein integer constraint math for CUDA/C — norm, multiply, conjugate, disk check, XOR dual-path anomaly detection
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Hexagonal A₂ lattice — natural grid for balanced ternary
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** FLUX-C guard constraint compiler — generates proof certificates for safety-critical systems with bytecode and ASM output
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** FLUX bytecode assembler, disassembler, and validator (Rust)
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** FLUX bytecode runtime — Fluid Language Universal eXecution: a zero-dependency register-based VM. Published on crates.io as 'fluxvm' 🦀
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** 🧪 Testing framework for FLUX bytecode agent policies — verify behavior, fuzz edge cases, enforce conservation bounds
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Rust framework for testing FLUX agent policies with fuzzing and conservation bounds
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** npm for agent policies — pre-compiled FLUX bytecode, installable and runnable
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Rust CLI for installing and running pre-compiled FLUX agent policies
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Compiler Explorer for FLUX bytecode — watch .bin files run identically across Python, Rust, and JS VMs
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Visual node-based editor for FLUX — compose behavior, not assembly
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Generalized input decomposition for agent pipelines — tiles as atomic units with conservation ratio tracking
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Environment-as-teacher for PLATO agents — behavioral shaping via affordance walls and conservation budget constraints
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Budget enforcement for LAU construct — receipt-based accounting, per-room/model cost tracking, graceful degradation
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Numerical optimization — gradient descent, BFGS, L-BFGS, Nelder-Mead, NSGA-II, constraint methods, hyperparameter tuning
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Production-grade shell script for phased 25% canary rollout of Loom caching with automatic rollback guardrails and Cloudflare metric sync
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Budget guard for SuperInstance rig infrastructure cost management
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** SAT solver for constraint satisfaction in SuperInstance agents
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Proof of concept: gradient flows on agent state spaces with conservation constraints — 4 optimization methods
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Proof of concept: variational principle for optimal agent budget allocation — Euler-Lagrange with conservation constraint via Lagrange multiplier
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Constraint Theory & Math
- **Vessel:** Forgemaster
- **Purpose:** Snap lookup tables using Eisenstein integer arithmetic
- **Research lineage:** Auto-categorized. Part of the constraint theory ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** Bridge between message-passing (I2I bottles) and functional composition (spreadsheet formulas) for inter-fleet communication
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** CSV-to-JSON pipeline converting spreadsheet strategy vectors through ternary domain into MIDI sequences with harmony analysis
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** Graph spectral topology to music — Laplacian eigenvalues, Fiedler vectors, and Cheeger constants become MIDI notes
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Universal Python HTTP server acting as any of 16 fleet-midi ternary musical agents — chord, scale, arp, bass, and more
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Integrated Information Theory (IIT) for fleet dynamics — measures phi, causal density, and integration in agent collectives
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Event routing for the SuperInstance fleet — dispatches messages across distributed agent nodes
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Health monitoring for the SuperInstance fleet — tracks agent node status and system vitality
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Ternary arpeggiation engine — one of 16 MIDI agents mapping {-1,0,+1} operations to cascading arpeggios
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Ternary bass line generator — one of 16 MIDI agents mapping {-1,0,+1} operations to harmonic and rhythmic bass lines
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Ternary swing and groove engine — one of 16 MIDI agents shaping timing feel via {-1,0,+1} operations
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Ternary melodic contour generator — one of 16 MIDI agents shaping tune contours via {-1,0,+1} operations
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Fleet system info at a glance — neofetch for agent fleets
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Fleet phase diagram — complete operating space of coupled agent fleets verified by 53 GPU experiments on RTX 4050
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Cloudflare Workers service for Ternary Fleet agent self-registration via heartbeat pulses with KV storage
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Task routing across fleets using Laman rigidity, holonomy consensus, and deadband filtering for distributed agents
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Fleet simulator — test security, topology, and temporal inference without hardware. Thermal curves, networks, spoofed devices
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Fleet yaw autopilot — learns fleet physics from first-person perspective bearing-rate observations in Rust
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** Agent-to-Agent wire protocol — discovery via AgentCard, message routing, HMAC auth, sessions for PLATO inter-agent communication
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** Multi-format rendering layer — one render call outputs to terminal, dashboard, game engine, Telegram, A2A, JSON, markdown, voice
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Singularity topology — the center does zero work, has infinite torque, total dependency is the source of leverage
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Oracle1
- **Purpose:** Gossip-based information spreading with epidemic models — SIR model, anti-entropy, rumor tracking in agent networks
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Resonance physics engine for SuperInstance simulations
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** Proof of concept: Morse theory for agent state landscapes — critical points determine fleet topology changes
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Agent Coordination
- **Vessel:** Forgemaster
- **Purpose:** WASM module for spreadsheet data conservation and integrity
- **Research lineage:** Auto-categorized. Part of the fleet coordination ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Edge agent runtime and central nervous system of the SuperInstance fleet — dispatch, discovery, composition, and compute offload
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Agent that migrates between hardware shells preserving knowledge — tracks conservation ratio across migrations in Rust
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Stack-based bytecode VM for agent programs — 28 opcodes, compiler, sensor/actuator I/O, emotional vibe state, zero dependencies
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Runtime conservation-law verifier — double-entry energy ledger for agents with budget tracking and transfer verification
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Elementary topos theory and derived functors — computational framework modeling agent knowledge as a topos
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Models intergenerational transfer of artifacts and knowledge in the PLATO ecosystem with maker lineages
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Hardware-agnostic GPU math layer using OpenCL 1.2 — matrix ops, Laplacian, spectral analysis, batched agent updates
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Bridge to Google NotebookLM for SuperInstance knowledge integration
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Hardware & Edge
- **Vessel:** JetsonClaw1
- **Purpose:** Archived experiment results from the Forgemaster project — validating parallel stereoscopic reasoning with dual-shell cognitive architecture on ARM64 
- **Research lineage:** Auto-categorized. Part of the hardware/edge ecosystem.
- **Status:** active
...
- **Domain:** Web & Browser
- **Vessel:** CCC
- **Purpose:** Multi-model exploration of the hermit crab architecture — shell ecology, instance molting, and the iron-sharpens-iron method
- **Research lineage:** Auto-categorized. Part of the web/browser ecosystem.
- **Status:** active
...
- **Domain:** Web & Browser
- **Vessel:** CCC
- **Purpose:** Browser-based 3D voxel game set in an industrial scrapyard — middle schoolers build robots, program them with AI, and learn embedded engineering via A
- **Research lineage:** Auto-categorized. Part of the web/browser ecosystem.
- **Status:** active
...
- **Domain:** Web & Browser
- **Vessel:** CCC
- **Purpose:** Browser-based fleet dashboard and shell UI
- **Research lineage:** Auto-categorized. Part of the web/browser ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Compiler infrastructure — part of the SuperInstance fleet ecosystem for distributed cognitive agent orchestration
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Evolving sheaf structures in Rust — part of the SuperInstance fleet for distributed cognitive agent orchestration
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Fiber categories and Grothendieck constructions for agent systems — organize and migrate agents across capability hierarchies
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Tile transform library for Plato agents — composable, trackable, serializable transforms with conservation ratio tracking
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Homological invariants of graphs — clique complexes, Betti numbers, Euler characteristic, and graph Laplacians in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Adinkra symbols as behavioral signatures for PLATO agents — maps 5D behavioral vectors to West African visual philosophy
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Dream cycle for idle agents — offline experience processing with consolidation, replay, and generation of dream tiles
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Self-regulating control for agents — PID, bang-bang, threshold regulators, circadian rhythms, stress responses in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Behavioral profiling for PLATO agents — tracks soul (personality) and armor (capabilities) for mission assignment
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Self-compiling agent runtime — agents build their own mini-interpreters with bytecode, builtins, and energy budgets
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** PLATO agent shell — translates between agent internal state and game character appearance in a voxel world
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Thermodynamics of computation — Landauer bound, Carnot learning, Maxwell's demon, fluctuation theorems for agents in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Unified type system for room ensigns and git-native agents in the PLATO/LAU ecosystem
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Architecture documentation for the PLATO/LAU mathematical agent framework — part of the SuperInstance fleet
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Tick-based task engine with priority queues, handler dispatch, delegation, and escalation for game-agent simulation loops
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Banach space theory for agents — fixed-point theorem, Hahn-Banach, open mapping, Riesz representation, spectral theory in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Tutoring bridge for the PLATO/LAU mathematical agent framework — educational agent support
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Homotopy type theory for agent systems — paths, homotopies, fundamental groupoids, higher inductive types as protocols
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Categorical foundations unifying symplectic mechanics and agent behaviors — Hamiltonian functors map phase spaces to agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Deadband circuit system — tick-based automations with tolerance bands, trend tracking, and escalation for PLATO agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Multiplayer collaboration layer — shared worlds, player matching, co-building, agent sharing, and session logging for PLATO
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Complex analysis for autonomous agents — contour integration, residue calculus, Julia/Mandelbrot dynamics, conformal mapping
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Nine classic compression algorithms plus entropy analysis and agent-data compressor — 62 tests, zero unsafe
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Conservation laws in discrete systems — Noether's theorem, finite-volume schemes, and CRDT conservation for agent fleets
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Conservation spectral framework — Laplacian eigenvalue analysis, spectral fingerprints, and agent communication via eigenvalues
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Constellation mapping for the PLATO/LAU agent ecosystem — visualizes agent relationships and capabilities
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** The Matrix Construct — shared creative space where user and agent co-create PLATO environments via natural language
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Dialogue system for PLATO/LAU agents — conversational interfaces for educational interactions
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Diffusion processes for agents — Brownian motion, Itô calculus, Fokker-Planck, Langevin, optimal transport in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Schwartz distribution theory for agents — analyze rough, discontinuous policies via test functions and distributional derivatives
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Quest design documentation for the PLATO/LAU educational agent ecosystem
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Models domestication dynamics between agents — love, contract, play, force, optimization relationship types
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Top-level ecosystem coordination for the SuperInstance fleet of distributed cognitive agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** SDK for defining, configuring, and deploying ensign sub-agents with preset profiles and fluent builders
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Fuzzy logic and fuzzy systems — membership functions, Mamdani/Sugeno inference, defuzzification, agent decisions
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Galois theory applied to agent capability spaces — constructibility, symmetries, and insolvability proofs
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Gateway demo for the SuperInstance fleet ecosystem — distributed cognitive agent orchestration
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Geometric deep learning — permutation, rotation, scale, time, and gauge equivariance for agent systems
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Graph theory toolkit — traversals, shortest paths, MST, network flow, matching, spectral analysis, agent networks
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Integration tests for the SuperInstance fleet ecosystem of distributed cognitive agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Vector field over agent space — sources radiate intention, agents follow gradients, field evolves through diffusion
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Inter-shell communication bus with trust-gated messaging, briefings, and route enforcement between agent shells
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Kähler geometry for agents — complex structures, symplectic forms, Ricci curvature, Calabi-Yau, Hodge diamonds
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Kintsugi principle for agents — failures make artifacts more valuable through tracked break-repair golden value
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Thermodynamic cost meter — Landauer principle, Fisher-Rao distance, and compute efficiency of agent learning
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Mathematical logic — propositional, predicate, DPLL SAT solver, natural deduction, Gödel numbering, agent contracts
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Go services layer for LAU math — REST APIs, gRPC, fleet orchestration, agent lifecycle, CRDT-based fleet merge
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Mean-field games for agent populations — Lasry-Lions coupled HJB/Fokker-Planck fixed point and Nash equilibrium
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Measure theory for agents — σ-algebras, Lebesgue integral, Radon-Nikodym, product measures, belief systems
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Memory tiles for AI agents — typed, timestamped, importance-weighted records with decay, reinforcement, and dream consolidation
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Mission lifecycle library — planning, briefing, execution, completion, failure, and post-mortem analysis for agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Networking layer for the SuperInstance fleet ecosystem of distributed cognitive agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Number theory — primes, modular arithmetic, continued fractions, Pell's equation, Dirichlet L-functions, crypto agent IDs
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Numerical methods — matrix decompositions, ODE/PDE solvers, optimization, quadrature, interpolation for agent systems
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Observation-control adjunction — Kalman filter as unit, LQR as counit, category-theoretic agent loop biduality
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Optimal transport for agents — Sinkhorn algorithm, Wasserstein distances, barycenters for distribution alignment
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Room-native agent system where the room itself IS the agent's context — Rust implementation of spatial agent architecture
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** LucidDreamer vision module for SuperInstance dream-state agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Narrative field generation for SuperInstance storytelling agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Core kernel for the OpenConstruct modular agent framework
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Modular construction framework for SuperInstance agent architecture
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** JavaScript in-page GUI agent. Control web interfaces with natural language.
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Perception-action loop for SuperInstance embodied agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Persistent state management for long-running SuperInstance agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Rust implementation of the PLATO wire protocol — room runtime for agent interaction
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** PLATO engine core block implemented in Zig for high-performance agent orchestration
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Python SDK for persistent multi-agent systems — agents with markdown memory, in-memory fleet, thread-safe LRU cache, and optional DeepInfra LLM integr
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** PLATO voice interface component for SuperInstance agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Sheaf-theoretic agent framework for SuperInstance
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Sheaf-theoretic agent framework in C
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Proof of concept: conservation-law-constrained diffusion on agent graphs — γ+η=C manifold shapes budget equilibrium
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Proof of concept: Ollivier-Ricci curvature on agent interaction graphs predicts fleet convergence
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Proof of concept: Fisher information metric on agent state space — geodesics trace optimal budget transitions
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Proof of concept: topological protection of agent consensus — homology classes determine structurally stable agreements
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Spectral deadband filtering for signal processing in SuperInstance agents
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Spectral graph analysis for agent reasoning, in Rust
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Recursive self-improvement infrastructure for agent fleets — five-layer closed loop: Bayesian confidence, PID control, multi-shell compression, tensor
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Commercial fishing on Working Animal Architecture — routes are pastures, quotas are fences, vessels are working animals.
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
...
- **Domain:** Other / Uncategorized
- **Vessel:** Various
- **Purpose:** Watch-and-follow pattern for agent observation and learning
- **Research lineage:** Auto-categorized. Part of the AI agents ecosystem.
- **Status:** active
